...
<body>
    <header class="d-flex justify-content-center align-students-center">
        <div class="logo">
    ...
    <main>
        <div class="satu">
            ...
            <table cellspacing="0" cellpadding="4">
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $dataSiswa['created_at']->format('j F, Y') }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $dataSiswa['noAyah'] }}</td>
                </tr>
                <tr>
                    <th width="50%">no hp ibu</th>
                    <td>:</td>
                    <td>{{ $dataSiswa['noIbu'] }}</td>
                </tr>
        ...
        <div class="dua">
            ...
            <p>Akses <a href="/login" id="link">http://127.0.0.1:8000/login   </a>, login dengan menggunakan:</p>
            <p>Email:{{ $dataSiswa['email'] }}</p>
            <p>Password:{{ $dataSiswa['nisn'] }}</p>
